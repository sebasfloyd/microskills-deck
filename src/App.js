...
import { ChevronRight, ChevronLeft, Play, Pause, BarChart2, Users, Brain, Globe, Zap, Check, Clock, Layers, Target, DollarSign, Award, TrendingUp } from 'lucide-react';
...
const InvestorDeck = () => {
  ...
  const slides = [
    ...
    // Slide 2: El Problema (mantenido con mejoras visuales)
    {
    ...
    // Slide 3: Nuestra Solución (mantenido con mejoras visuales)
    {
    ...
    // Nuevo Slide 4: Características del Producto
    {
    ...
    // Nuevo Slide 5: Demostración del Producto
    {
    ...
    // Slide 6: Modelo de Negocio (actualizado con gráfico)
    {
              ...
              <div className="flex justify-around mt-4">
                {pieData.map((entry, index) => (
                  <div key={entry.name} className="text-center">
                    <div className="w-4 h-4 rounded-full inline-block mr-2" style={{ backgroundColor: COLORS[index % COLORS.length] }}></div>
    ...
    // Slide 7: Tracción y Métricas (actualizado con gráfico mejorado)
    {
    ...
    // Slide 8: Equipo (actualizado con más detalles)
    {
    ...
    // Slide 9: Inversión y Uso de Fondos (actualizado con gráfico)
    {
    ...
    // Nuevo Slide 10: Ventaja Competitiva
    {
      ...
      content: (
        <motion.div 
          ...
          className="space-y-6"
        >
          <h2 className="text-4xl font-bold text-blue-600 mb-4">¿Por qué MicroSkill?</h2>
          <div className="grid grid-cols-2 gap-6">
            <motion.div 
              className="bg-white p-6 rounded-lg shadow-lg"
              initial={{ opacity: 0, x: -20 }}
              ...
              transition={{ delay: 0.2 }}
            >
              <h3 className="text-2xl font-bold mb-4">Diferenciadores Clave</h3>
              <ul className="space-y-2">
                {[
                  "IA avanzada para personalización extrema",
                  "Micro-simulaciones basadas en escenarios reales",
                  "Integración seamless con flujos de trabajo existentes",
                  "Análisis predictivo de necesidades de capacitación",
                  "Comunidad global de aprendizaje colaborativo"
                ].map((item, index) => (
            ...
            <motion.div 
              ...
              transition={{ delay: 0.4 }}
            >
              <h3 className="text-2xl font-bold mb-4">Impacto en Clientes</h3>
              <ul className="space-y-4">
                {[
                  { metric: "Aumento en productividad", value: "32%" },
                  { metric: "Mejora en retención de empleados", value: "28%" },
                  { metric: "Reducción en tiempo de onboarding", value: "45%" },
                  { metric: "Incremento en satisfacción laboral", value: "40%" }
                ].map((item, index) => (
    ...
    // Nuevo Slide 11: Roadmap
    {
      title: "Roadmap y Visión Futura",
      content: (
        <motion.div 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          ...
          className="space-y-6"
        >
          <h2 className="text-4xl font-bold text-purple-600 mb-4">Nuestro Camino Hacia el Futuro</h2>
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <motion.ul className="space-y-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2, staggerChildren: 0.1 }}>
              {[
                { year: "2024", milestone: "Lanzamiento de MicroSkill 2.0 con IA mejorada" },
                { year: "2025", milestone: "Expansión a 20 nuevos mercados internacionales" },
                { year: "2026", milestone: "Integración de Realidad Virtual en simulaciones" },
                { year: "2027", milestone: "Lanzamiento de MicroSkill Enterprise para grandes corporaciones" },
                { year: "2028", milestone: "Alcanzar 50M de usuarios activos globalmente" }
              ].map((item, index) => (
                <motion.li 
                  key={index}
                ...
                >
                  <div className="w-20 h-20 bg-purple-100 rounded-full flex items-center justify-center">
                    <span className="text-xl font-bold text-purple-600">{item.year}</span>
                  </div>
                  <div className="flex-1 bg-purple-50 p-4 rounded-lg">
                    <p className="text-lg font-semibold">{item.milestone}</p>
                  </div>
                </motion.li>
              ))}
            </motion.ul>
          ...
          >
            ...
            <p className="text-lg">Transformar el aprendizaje corporativo global, haciendo que el desarrollo profesional sea accesible, efectivo y personalizado para cada individuo, impulsando la innovación y el crecimiento en organizaciones de todo el mundo.</p>
          </motion.div>
        </motion.div>
      )
    },
